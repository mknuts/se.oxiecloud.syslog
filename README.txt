...
"Message" is the only mandatory parameter on the flow card, all the others have defaults making it possible to add logging to your flows with a minimal effort.
